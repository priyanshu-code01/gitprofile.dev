    ...
    return (
        <form onSubmit={onSubmit} className="mb-8">
            <div className="flex gap-4 max-w-2xl mx-auto">
                ...
                <button type="submit" disabled={loading} className="px-8 py-4 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-colors duration-200">{loading ? 'Searching...' : buttonText}</button>
            </div>
        </form>
    )
}
